...
public class Deck {
		...
		public ArrayList<Card> usedCard=new ArrayList<Card>();//新增一個public filed:ArrayList<Card> usedCard
		 ...
		 * for迴圈表示洗牌洗1000次
		 * 亂數隨機選一個數字放在a裡面，範圍是cards的大小
		 * 從cards選出第a張排放入temp
		 * 把cards第a張牌與第一張牌位子交換，做洗牌的動作
		 * nUsed歸零
		 * usedCard清空
		 */
		public void shuffle(){
